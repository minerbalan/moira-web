...
const Alert = ({ className, color, children, onCloseClick }: AlertProps): JSX.Element => {
  ...
  return (
    <>
      <div
        className={`flex items-center justify-between text-white px-6 py-4 border-0 rounded mb-4 w-full ${colorName} ${
          className ?? ""
        }`}
      >
        ...
        <div>
          <button className="text-xl inline-block ml-5 outline-none focus:outline-none" onClick={onCloseClick}>
